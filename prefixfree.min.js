            ...
            link: function (a) {
                ...
                l = function () {
                    ...
                    if (b && a.parentNode && (!c.status || 400 > c.status || 600 < c.status)) {
                        ...
                        }), n = d.replace(/([\\\^\$*+[\]?{}.=!:(|)])/g, "\\$1"), b = b.replace(RegExp("\\b(behavior:\\s*?url\\('?\"?)" + n, "gi"), "$1");
                ...
                try {
                    ...
                    "undefined" != typeof XDomainRequest && (c = new XDomainRequest, c.onerror = c.onprogress = function () {
                    }, c.onload = l, c.open("GET", b), c.send(null))
                }
                ...
                var b = a.getAttribute("style"), b = e.fix(b, !1, a);
...
(function (m) {
    ...
    if (window.StyleFix && window.getComputedStyle) {
        ...
        (function () {
            ...
            if (f && 0 < f.length)for (var g = 0; g < f.length; g++)k(f[g]); else for (var c in f)k(StyleFix.deCamelCase(c));
            var g = 0, e, p;
        ...
        (function () {
            ...
            var e = document.createElement("div").style,
                k;
            for (k in d) {
                var g = d[k], c = g.property, g = k + "(" + g.params + ")";
        ...
        (function () {
            ...
            for (k in d) {
                var g = d[k] || k, c = k.replace(/::?/, function (b) {
                    return b + a.prefix
                });
